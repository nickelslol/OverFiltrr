...
The `rich` library is now included to provide colourful console logging with a simplified layout.
...
- Console output uses `RichHandler` for colourful logging with a simple time/level/message format.
